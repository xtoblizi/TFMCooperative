...
namespace TFMCooperativeSociety.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly TFMCooperativeDB _db = new TFMCooperativeDB();

        public AccountController()
        {
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager , TFMCooperativeDB db)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(user.UserName, model.Password, model.RememberMe, shouldLockout: false);
                switch (result)
                {
                    case SignInStatus.Success:                 
                        return RedirectToAction("DashBaord", "Home", new { id = User.Identity.GetUserId() });
        ...
        public async Task<ActionResult> RegisterMember(RegisterMemberViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.Message = "Registration was NOT Succesul, Try again ";
                    return View(model);
                }
